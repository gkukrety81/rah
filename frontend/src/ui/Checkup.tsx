...
export default function Checkup() {
    ...
    const [reco, setReco] = useState(""); // purple box
    ...
    const grouped: Record<Group, Question[]> = {
                ...
                <div className="mt-6 bg-white rounded-2xl border overflow-hidden">
                    ...
                    {!!blurb && (
                        <div className="px-6 py-4 bg-emerald-50 text-emerald-900">
                            ...
                            <div className="text-sm leading-relaxed whitespace-pre-wrap">{blurb}</div>
                        </div>
                    )}
                    ...
                    {!!reco && (
                        <div className="px-6 py-4 bg-fuchsia-50 text-fuchsia-900">
                            ...
                            <div className="text-sm leading-relaxed whitespace-pre-wrap">{reco}</div>
                        </div>
                    )}
